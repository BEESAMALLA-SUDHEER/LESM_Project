...
public class ReleaseEmpServiceImp {
	...
	public MasterEmployeeDetails get(String lancesoftId) {
	...
	public void approveRequest(String lancesoftId, boolean empstatus, Principal principal) {
	...
	public String releaseEmployeeDetailss(String oldemp, String newemp) {
	...
	//release emp service
    public List<MasterEmployeeDetails> getonholdEmpls(Principal principal) {
